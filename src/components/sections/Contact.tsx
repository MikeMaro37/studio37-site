  ...
  return (
    <section id="contact" className="relative bg-black text-white pt-[200px] pb-[120px] px-6 text-center overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <a href="mailto:hello@studio37.net" className="inline-flex items-center gap-3 text-[22px] font-normal text-white no-underline border-b border-hairline-dark pb-2.5 hover:border-white transition-colors group">
          hello@studio37.net
